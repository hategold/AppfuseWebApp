...
import yt.item8.dao.UserDao;
import yt.item8.model.User;
import yt.item8.service.MailEngine;
import yt.item8.service.UserExistsException;
import yt.item8.service.UserManager;
import yt.item8.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "yt.item8.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see yt.item8.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
