...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see yt.item8.service.impl.PasswordTokenManager#generateRecoveryToken(yt.item8.model.User)
     */
    @Override
    ...
    /**
     * @see yt.item8.service.impl.PasswordTokenManager#isRecoveryTokenValid(yt.item8.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see yt.item8.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
